...
<div id="my-tab-content" class="tab-content">
    ...
    <div class="tab-pane" id="password"> <!-- tab-pane active -->
        <h1>Encrypt with Password</h1>
            <form class="form-signin" action="encrypted" method="post">
                ...
                <div class="controls controls-row">
                    <button class="btn btn-large btn-primary" type="submit">Encrypt</button>
                </div>
            </form>
    </div>
    ...
    <div class="tab-pane active" id="two">
        <h1>Encrypt with 2 Keys</h1>
            <form class="form-signin" action="encrypted" method="post">
                ...
                <textarea type="text" rows="4" name="text" placeholder="Text" oninput="change_min();" id="text2"></textarea>
                ...
                <div class="controls control-row">
                    <a href="#" id='tooltip' data-toggle="tooltip" data-placement="bottom" title="Length of ciphertext"><input class="input-small" type="number" name="clength" id="clength" min="2" step="2" value="2"></a>
                    <label class="checkbox inline">
                        <a href="#" id='tooltip2' data-toggle="tooltip" data-placement="bottom" title="Use minimum length for ciphertext"><input type="checkbox" name="min" value="t"></a> Use Min Length
                    </label>
                </div>
...
<script>
function change_min() {
    document.getElementById("clength").value = document.getElementById("text2").value.length * 2;
}
</script>
